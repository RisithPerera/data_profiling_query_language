...
public class PositionTreeIndex {
    private final TreeMap<String, IntArrayList> clusters; //Including single clusters

    PositionTreeIndex(TreeMap<String, IntArrayList>  clusters) {
    ...
    public PositionTreeIndex intersect(PositionTreeIndex other) {
        ...
        return new PositionTreeIndex(intersectClusters);
    }
