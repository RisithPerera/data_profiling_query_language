...
public class QueryTest {
    ...
    public static void initConfig() throws Exception {
        ...
        DatasetConfig config = datasets.stream()
                .filter(d -> d.getName().equals("TEST2"))
                .findFirst()
...
//        inputConfig.setFILE_SKIP_DIFFERING_LINES(true);
//        inputConfig.setFILE_SKIP_LINES(0);
//        inputConfig.setFILE_ESCAPE("\\");
//        inputConfig.setFILE_STRICT_QUOTES(false);
